...
const Header = () => {
  ...
  return (
    <>
      {/*  Top Part */}
      <div className="bg-persian-red">
        <div className="top-header font-primary container flex h-auto flex-col flex-wrap justify-between gap-2 py-3 text-white md:h-20 md:flex-row md:flex-nowrap md:items-center md:gap-0">
          {/* Logo and Location  */}
      ...
      {/* Header Part  */}
      <header className="font-primary border-persian-blue/10 sticky top-0 z-50 border-b bg-[#F2F8FD] shadow-sm">
        <nav>
